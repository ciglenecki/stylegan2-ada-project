# source: https://github.com/happy-jihye/FFHQ-Alignment/blob/master/FFHQ-Alignmnet/ffhq-align.py
import os
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-s", "--src", default="./raw_images", help="directory of raw images"
    )
    parser.add_argument(
        "-d", "--dst", default="./aligned_images", help="directory of aligned images"
    )
    parser.add_argument(
        "-o",
        "--output_size",
    ...
    for img_name in glob.glob(args.src):
        ...
        for i, face_landmarks in enumerate(
            landmarks_detector.get_landmarks(str(img_path)), start=1
        ):
